...
* Run comprehensive system testing to measure stability and capture evidence screenshots.
* Prepare a resource clean-up script/plan to prevent unwanted costs.
* Participate in the second AWS/AWS Study Group technical event/webinar (Event 2).
* Work at the office (Sessions 7 and 8).
...
* System runs stably under advanced functional tests, with complete screenshot proofs.
* Completed resource clean-up documentation and methods.
* Attended Event 2 and documented it in the report.
* Reached 8 office sessions in total.
