...
#### JENKAM Web Platform
+ **JENKAM (WEB_CAFE)** is a comprehensive web-based coffee shop, inventory, and revenue management system. It is designed to work seamlessly alongside the **BrewMaster Pro (Java Swing Desktop App)** by sharing a single database.
...
In this workshop, you will deploy the JENKAM application on AWS using a cost-effective, scalable, and highly available hybrid cloud architecture:
